...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('dashboard')->name('dashboard.')->group(function () {
        Route::middleware('can:apply job')->group(function () {
            ...
            Route::get('my-applications/{job_candidate}', [DashboardController::class, 'my_application_details'])->name('my.appliaction.details');
        });
    });
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware('can:manage applicants')->group(function () {
            ...
            Route::get('/candidate/{job_candidates}/resume/download', [JobCandidateController::class, 'download_file'])->name('download_resume');
        });
    });
});
